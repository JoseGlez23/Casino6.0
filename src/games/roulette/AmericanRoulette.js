// src/games/roulette/AmericanRoulette.js
...
// Configuración de la ruleta - Orden profesional
const SEGMENTS = [
  { num: 0, color: "green" },
  { num: 28, color: "black" },
  { num: 9, color: "red" },
...
const BET_TYPES = {
  ...
  ZERO: { type: "ZERO", label: "0", multiplier: 36, numbers: [0] },
  DOUBLE_ZERO: {
    type: "DOUBLE_ZERO",
    label: "00",
    multiplier: 36,
  ...
  STRAIGHT: { type: "STRAIGHT", label: "PLENO", multiplier: 36, numbers: [] },
};
...
const BET_GROUPS = [
  ...
  [BET_TYPES.ZERO, BET_TYPES.DOUBLE_ZERO, BET_TYPES.STRAIGHT],
];

// Tabla de premios de tickets para la ruleta
...
export default function AmericanRoulette({ navigation }) {
  const {
    manekiCoins,
    tickets,
    subtractCoins,
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        {/* Selector de cantidad - Solo se muestra en paso 1 */}
        {betStep === "amount" && (
        ...
        {/* Selector de tipo de apuesta - Solo se muestra en paso 2 */}
        {betStep === "type" && (
        ...
        {/* Ruleta - Versión mejorada con borde dorado */}
            ...
            <Animated.View
              style={[
                styles.wheel,
                {
                  ...
                  borderRadius: wheelSize / 2, // Hacer la ruleta circular
                },
              ]}
            >
              <Svg width={wheelSize} height={wheelSize}>
                ...
                {/* Números - POSICIONAMIENTO CORREGIDO */}
                {SEGMENTS.map((segment, index) => {
                ...
                {/* Centro */}
                <Circle cx={center} cy={center} r={6} fill="#FFD700" />
              </Svg>
            </Animated.View>
...
const styles = StyleSheet.create({
  ...
  // Header mejorado con saldo y tickets
  header: {
    flexDirection: "row",
